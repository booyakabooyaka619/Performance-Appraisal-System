...
export default function Rb1() {
    ...
    useEffect(() => {
        const calculateScore = () => {
            const scoreMap = {
                conferenceQuality: {
                    "IEEE/Springer/ACM/IIMs/IITs/INDAM (1.5)": 1.5,
                    "State college + AICTE/IEEE/ISTE (0.9)": 0.9,
                    "University sponsored (0.5)": 0.5,
                    "Other (0)": 0,
                },
                level: {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (isEditing) {
                response = await fetch(`http://localhost:5000/api/rb1form/${editFormId}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(dataToSubmit),
                });
            } else {
                response = await fetch('http://localhost:5000/api/rb1form', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(dataToSubmit),
                });
    ...
    const handleEdit = (form) => {
        setFormData({
            conferenceQuality: form.conferenceQuality,
            level: form.level,
    ...
    const handleDelete = async () => {
        try {
            const response = await fetch(`http://localhost:5000/api/rb1form/${deleteFormId}`, { method: 'DELETE' });
                ...
                {!showForm ? (
                            ...
                            {submittedForms.length === 0 ? (
                                ...
                                <div className="submitted-form">
                                    ...
                                    <table className="submitted-table">
                                        <tbody>
                                            <tr><td><strong>Quality of Conference:</strong></td><td>{submittedForms[currentPage - 1]?.conferenceQuality}</td></tr>
                                            ...
                                            <tr><td><strong>Type of Presentation:</strong></td><td>{submittedForms[currentPage - 1]?.presentationType}</td></tr>
                                            <tr>
                    ...
                    <form className='form-container' onSubmit={handleConfirmSubmit}>
                        ...
                        <div className="marks-container">
                            ...
                            <div className="marks-item marks-item-value">94</div>
                        ...
                        <div className='form-group'>
                            <label className='label1'>Quality of Conference:
                                <select name="conferenceQuality" className="select-input" value={formData.conferenceQuality} onChange={handleChange}>
                                    <option value="">Select</option>
                                    <option value="IEEE/Springer/ACM/IIMs/IITs/INDAM (1.5)">IEEE/Springer/ACM/IIMs/IITs/INDAM (1.5)</option>
                                    <option value="State college + AICTE/IEEE/ISTE (0.9)">State college + AICTE/IEEE/ISTE (0.9)</option>
                                    <option value="University sponsored (0.5)">University sponsored (0.5)</option>
                                    <option value="Other (0)">Other (0)</option>
                                </select>
                            </label>
                        </div>
                        ...
                        <div className='form-group'>
                            <label className='label1'>Level:
                                <select name="level" className="select-input" value={formData.level} onChange={handleChange}>
                                    ...
                                    <option value="State (0.8)">State (0.8)</option>
                                    <option value="Other (0)">Other (0)</option>
                                </select>
                            </label>
                        </div>
                        ...
                        <div className='form-group'>
                            <label className='label1'>Type of Presentation:
                                <select name="presentationType" className="select-input" value={formData.presentationType} onChange={handleChange}>
                                    <option value="">Select</option>
                                    <option value="Oral (1)">Oral (1)</option>
                                    <option value="Poster (0.5)">Poster (0.5)</option>
                                </select>
                            </label>
                        </div>
