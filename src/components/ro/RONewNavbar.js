...
import { faBars, faHome, faUser, faBell } from '@fortawesome/free-solid-svg-icons'; // Added Home and User icons
import './ronewnavbar.css'


export default function RONewNavbar({ user, onLogout }) {
    ...
    return (
        <div className="homnavbar-container">
            ...
            <div className="homcontents">
                ...
                {/* <Link to="/professorhome" className="homsubcontent">Summary</Link>
